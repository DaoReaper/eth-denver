...
// node ./scripts/hardhat/request.js
...
async function main() {
    ...
    const signerPrivateKey = process.env.PK
    const signer = new ethers.Wallet(signerPrivateKey, provider)

    // Consumer contract
    const consumerAddress = '0xa1F4E605585D8e7a3160938Cbe873D03525a95d8'

    // const consumerAbiPath = './artifacts/contracts/ReaperConsumer.sol/ReaperConsumer.json'
    const consumerAbiPath = './artifacts/contracts/ReaperConsumer.sol/ReaperConsumer.json'
    ...
    // const args = ["ETH", "USD"]
    const args = ["20, 10, 12, 70", "2, 5, 3, 1"]
    ...
    const oracleAbiPath = './artifacts/contracts/chainlink/dev/functions/FunctionsOracle.sol/FunctionsOracle.json'
    ...
    console.log(requestTxReceipt.logs);
